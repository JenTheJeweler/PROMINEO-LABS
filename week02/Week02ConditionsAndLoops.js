...
if (studentGrade >= 0 && studentGrade <= 6 ) {studentClass = "Elementary"}
else if (studentGrade == 7 || studentGrade == 8 ) {studentClass = "Middle"} 
else if (studentGrade == 9) {studentClass = "Freshman"}
else if (studentGrade == 10) {studentClass = "Sophomore"
}else if (studentGrade == 11) {studentClass = "Junior"}
else if (studentGrade == 12) {studentClass = "Senior"} 
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
//For loop prints 10 to -10:works
//let i=0 // start
//i == -10 //stop condition
//i-- //incrementor 
//for (let i = 0; i > -11; i--) {
 ...
 * ↓ YOUR CODE HERE ↓ */
   ...
   //either change the start number to be less than 10, and change the stop function to less than , 
   //or make the incrementor a decrementor
